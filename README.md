...
- Интеграция с преобразователями интерфейсов (мостами):
    ...
    - FPGA (преимущественно Gowin): FPGA выступает универсальным решением для приема любых нестандартных интерфейсов (включая высокоскоростные CameraLink). FPGA выполняет роль моста - декодирует входной сигнал и упаковывает его в пакеты MIPI CSI или передает по PCIe.
