...
| **Встроенный накопитель** | eMMC / UFS | Система и логи, от 8 ГБ до 128 ГБ (по согласованию с заказчиком) |
| | NVMe SSD | M.2 NVMe диск от 128 ГБ до 4 ТБ — **по согласованию с заказчиком** |
| | Слот microSD | **есть** |
...
| **Камерный модуль** | Сенсор (референсная модель) | **Gpixel**, **Smartsens** — *модель по согласованию с заказчиком* |
...
<img src="start88_smart-camera_fbd.drawio.svg" alt="Блок-схема модульной камеры" width="1024"/>
