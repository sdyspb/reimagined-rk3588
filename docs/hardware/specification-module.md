...
| **Встроенный накопитель** | eMMC / флэш‑память | от 8 ГБ до 128 ГБ (по согласованию с заказчиком) |
| | NVMe SSD | наличие встроенного NVMe‑диска — **по согласованию с заказчиком** |
| | Слот microSD | **есть** |
...
| **Видео и ISP** | Декодирование | 8K@30fps, 4K@120fps (H.265/HEVC, VP9, AVS2, AV1); 4K@60fps (H.264/AVC) |
| | Кодирование | 4K@60fps (H.265/HEVC, H.264/AVC) |
...
| | Частота кадров | **≥60 fps** - *фактическая величина зависит от устанавливаемого модуля* |
...
| **Корпус и защита** | Степень защиты | IP67 (пылевлагонепроницаемый, алюминий с радиатором) |
...
<img width="1024" height="439" alt="start88_smart-camera_fbd drawio" src="https://github.com/user-attachments/assets/2baab8c5-11d7-4075-911a-b1f776a22b49" />
